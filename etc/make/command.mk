...
install: build-env docker-pull start-proxy install-npm build-newman install-deps docker-network install-hosts install-hooks
...
## @Check Check all tests
check-all:
	@bin/grumphp run --testsuite=check-all
